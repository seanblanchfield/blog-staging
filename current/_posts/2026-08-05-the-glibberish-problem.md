...
There's a rapid change happening in our inboxes and channels. Suddenly, everything is *load-bearing*. Every advantage is *durable*. Every company sits at the *intersection* of three enormous ideas. And every ordinary observation arrives with its own drum roll. It is superfically good, but there's nothing beneath the surface. If you try to polish it, entire paragraphs collapse. This is worse than being flooded with "AI slop". It's sometimes convincing enough, but it is never great, and it shortcuts the opportunity for people to make it great.
